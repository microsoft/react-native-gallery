  ...
  return (
    ...
    <Pressable
      ...
      <View style={{flexShrink: 1}}>
        <Text style={styles.controlItemTitle} maxFontSizeMultiplier={1}>{item.key}</Text>
        <Text style={styles.controlItemSubtitle} maxFontSizeMultiplier={1}>{item.subtitle}</Text>
      </View>
